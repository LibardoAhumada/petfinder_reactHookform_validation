...
import { useRef } from "react"; // Importa useRef si no lo has hecho
...
function App() {
  const {
    ...
    defaultValues: {
      name: "",
      email: "",
      birthDate: "", // Corregido el nombre del campo
      password: "",
      confirmPassword: "", // Corregido el nombre del campo
      country: "mx",
      file: "",
      agreeTerms: false,
      petname:"",
  ...
  password.current = watch("password", ""); // Asegúrate de que watch("password") se use correctamente
...
<div>
  ...
  >
    ...
    {/* Agrega más opciones para otros países si es necesario */}
  </select>
...
<div>
  ...
  <input
    ...
    onChange={(e) => {
      ...
      if (isValid) {
        // Puedes acceder a las fotos de la mascota usando "files" en el onSubmit
...
<h2>Registro de extravio de: {watch("petname")}</h2>
  ...
  <input
    ...
    {...register("petLoseDate", {
      ...
      validate: (value) => {
        ...
        return petLoseDate <= actualDate || "La fecha de extravío debe ser anterior o igual a la fecha actual";
      },
    })}
  />
